...
`DOCX <https://github.com/open-ortho/dent-oip/releases/download/v0.2.6-dev/DENT-OIP.docx>`__ | `PDF <https://github.com/open-ortho/dent-oip/releases/download/v0.2.6-dev/DENT-OIP.pdf>`__
