...
This normative section contains extensions to DICOM tags defined in the SOP Common module which are relevant to orthodontic image acquisition.

**References:**

+ `DICOM PS3.3: C.12.1 <https://dicom.nema.org/medical/dicom/current/output/html/part03.html#sect_C.12.1>`_

.. list-table:: **Table 7.4.1.9-1 SOP Common Module Attribute Requirements**
    :header-rows: 1
