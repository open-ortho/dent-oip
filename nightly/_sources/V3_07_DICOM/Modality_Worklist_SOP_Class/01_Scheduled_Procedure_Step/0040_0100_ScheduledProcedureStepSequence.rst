...
Define the types of images, also known as "Image Views" in ADA-1100. ADA-1100
refers to these as views from the perspective of defining the photograph. In
DICOM, we consider them as a requested procedure, which encompasses a more
functional approach. This protocol outlines the methods used to acquire these
images, such as instructing the patient to smile and capturing a photograph of
their face while smiling...
